import { CleanTeamEventModel, ErrorModel } from '../../models';
...
export async function validateCleanTeamData(
    formData: FormData
): Promise<{ data: CleanTeamEventModel | null, errors: Map<string, ErrorModel> }> {
    ...
    let data: CleanTeamEventModel | null = null;
